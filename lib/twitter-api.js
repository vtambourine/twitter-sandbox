...
TwitterAPI.REQUEST_ACCESS_TOKEN = {
    method: 'post',
...
TwitterAPI.prototype.obtainRequestToken = function () {
    return this.request(TwitterAPI.REQUEST_TOKEN).then(function (response) {
        return response;
...
TwitterAPI.prototype.obtainAccessToken = function (verifier, token) {
    var request = TwitterAPI.REQUEST_ACCESS_TOKEN;
...
TwitterAPI.prototype.verifyCredentials = function () {
